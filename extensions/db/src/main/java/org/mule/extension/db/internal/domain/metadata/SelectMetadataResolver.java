...
public class SelectMetadataResolver extends DefaultDbMetadataResolver implements MetadataOutputResolver<String> {
  ...
  public MetadataType getOutputMetadata(MetadataContext context, String query)
    ...
    if (statementMetaData == null) {
      throw new MetadataResolvingException(String.format("Driver did not return metadata for the provided SQL: [%s]", query),
